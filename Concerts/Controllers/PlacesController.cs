...
namespace Concerts.Controllers
{
    public class PlacesController : Controller
    {
        ...
        public PlacesController(ConcertsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PlaceId,Place_Name,Place_Address")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaceId,Place_Name,Place_Address")] Place place)
        {
            if (id != place.PlaceId)
            {
                return NotFound();
